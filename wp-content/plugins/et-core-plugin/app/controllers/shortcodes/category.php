            ...
            for ( $i=0; $i < 3; $i++ ) {
                ...
                if ( $options['product_objects_content'][$i]['to_show'] ) {
                    ...
                    if ( has_post_thumbnail( $options['product_objects_content'][$i]['id'] ) ) {
                        ...
                        $options['product_objects_content'][$i]['img'] = get_the_post_thumbnail( $options['product_objects_content'][$i]['id'], 'shop_catalog', $options['product_objects_content'][$i]['img_attr'] );
                    }
                    else 
            ...
            if ( $options['products']->have_posts() ) : ?>
                    ...
                    <?php while ( $options['products']->have_posts() ) : $options['products']->the_post();
                        ...
                        if ( has_post_thumbnail( $id ) ) {
                            ...
                            $options['product_objects_content'][$i]['img'] = get_the_post_thumbnail( $atts['fp_id'], 'shop_catalog', $options['product_objects_content'][$i]['img_attr'] );
                        }
                        else 
                            $options['product_objects_content'][$i]['img'] = wc_placeholder_img();
