				...
				<?php 
					if( ! empty( $atts['subtitle'] ) ) {
						if ( class_exists( 'Vc_Manager' ) && !$atts['is_elementor'] ) 
							...
							echo '<'.$atts['subtitle_html_tag'].' class="banner-subtitle ' . $atts['subtitle_class'] . '">' . esc_html( $atts['subtitle'] ) . '</'.$atts['subtitle_html_tag'].'>';
					}
					...
					if( ! empty( $atts['title'] ) ) {
						if ( class_exists( 'Vc_Manager' ) && !$atts['is_elementor'] ) 
							...
							echo '<'.$atts['title_html_tag'].' class="banner-title ' . $atts['title_class'] . '">' . esc_html( $atts['title'] ) . '</'.$atts['title_html_tag'].'>';
					}
				?>
