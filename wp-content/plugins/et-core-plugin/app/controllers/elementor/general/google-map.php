...
class Google_Map extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'XStore Google Map', 'xstore-core' );
	}
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'tabs',
			[
				'label' => __( 'Pin Item', 'xstore-core' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'default' => [
					[
						'pin_title' => __( 'Pin #1', 'xstore-core' ),
						'pin_notice' => __( 'Find Latitude & Longitude', 'xstore-core' ),
						'pin_lat' => __( '1.2833754', 'xstore-core' ),
						'pin_lng' => __( '103.86072639999998', 'xstore-core' ),
						'pin_content' => __( 'I am item content. Click edit button to change this text. Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut elit tellus, luctus nec ullamcorper mattis, pulvinar dapibus leo.', 'xstore-core' ),
					],
				], 
		...
		$this->start_controls_section(
			'section_main_style',
			[
				'label' => __( 'Pin Global Styles', 'xstore-core' ),
	...
	protected function render() {
		...
		if ( \Elementor\Plugin::$instance->editor->is_edit_mode() ) {
			if ( function_exists('etheme_enqueue_style')) {
				etheme_enqueue_style( 'etheme-google-map', true );
			}
		}
