...
class Text_Button extends \Elementor\Widget_Base {
	...
	protected function _register_controls() {
		...
		$this->add_control(
			'style',
			[
				'label' 		=>	__( 'Animation Effect', 'xstore-core' ),
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					...
					'{{WRAPPER}} .fill-underline:before' => 'height: {{SIZE}}{{UNIT}};',
                    '{{WRAPPER}} .fill-overline:before' => 'height: {{SIZE}}{{UNIT}};',
				],
			]
		);
...
//
		...
		$this->add_control(
			...
			[
				...
				'description' => 'Overline, underline, circle colors',
				'type' => \Elementor\Controls_Manager::COLOR,
				'default' => '#000000',
				'selectors' => [
...
//
	...
	protected function render() {
		...
		if ( function_exists( 'etheme_enqueue_style' ) ) {
			etheme_enqueue_style( 'etheme-text-button', true );
		}
        ...
        $this->add_render_attribute( 'text_button', 'class', 'etheme-text-button' );
		$this->add_render_attribute( 'text_button', 'class', 'elementor-button' );
		$this->add_render_attribute( 'text_button', 'role', 'button' );
		
		if ( $settings['button_animation'] != 'none' ) {
			$this->add_render_attribute( 'button_wrapper', 'class', 'etheme-animated');
            $this->add_render_attribute( 'button_wrapper', 'class', 'etheme-animation-' . $settings['button_animation']);
		}
