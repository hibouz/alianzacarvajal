...
class Price_Table extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Price table', 'xstore-core' );
	}
...
//		$this->add_control(
//			'heading_title_bg_color',
//			[
//				'label' => __( 'Background Color', 'xstore-core' ),
//				'type' => \Elementor\Controls_Manager::COLOR,
//				'selectors' => [
//					'{{WRAPPER}} .etheme-price-table-title' => 'background-color: {{VALUE}};',
//				],
//                'condition' => [
//                    'title!' => ''
//                ]
...
//		$this->add_control(
//			'heading_subtitle_bg_color',
//			[
//				'label' => __( 'Background Color', 'xstore-core' ),
//				'type' => \Elementor\Controls_Manager::COLOR,
//				'selectors' => [
//					'{{WRAPPER}} .etheme-price-table-subtitle' => 'background-color: {{VALUE}};',
//				],
//                'condition' => [
//                    'subtitle!' => ''
//                ]
...
//				'type' => \Elementor\Controls_Manager::COLOR,
//				'selectors' => [
//					'{{WRAPPER}} .etheme-price-table-price-wrapper' => 'background-color: {{VALUE}};',
//				],
//				'default' => '#fafafa'
//			]
//		);
...
//				'label_block' => false,
//				'options' => [
//					'below' => __( 'Below', 'xstore-core' ),
//					'beside' => __( 'Beside', 'xstore-core' ),
//				],
//				'default' => 'below',
//				'condition' => [
//					'period!' => '',
...
//		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
//					'{{WRAPPER}} .etheme-price-table-features-list li + li:before' => 'margin-left: calc((100% - {{SIZE}}%)/2); margin-right: calc((100% - {{SIZE}}%)/2)',
...
//				'type' => \Elementor\Controls_Manager::COLOR,
//				'selectors' => [
//					'{{WRAPPER}} .etheme-price-table-footer' => 'background-color: {{VALUE}}',
//				],
//                'default' => '#fafafa'
//			]
//		);
...
//				'default' => 'md',
//				'options' => [
//					'xs' => __( 'Extra Small', 'xstore-core' ),
//					'sm' => __( 'Small', 'xstore-core' ),
//					'md' => __( 'Medium', 'xstore-core' ),
//					'lg' => __( 'Large', 'xstore-core' ),
//					'xl' => __( 'Extra Large', 'xstore-core' ),
//				],
//				'condition' => [
//					'button_text!' => '',
//				],
...
//				'type' => \Elementor\Controls_Manager::COLOR,
//				'selectors' => [
//					'{{WRAPPER}} .etheme-price-table-ribbon-inner' => 'background-color: {{VALUE}}',
//				],
////				'default' => '#fafafa'
//			]
//		);
...
//				],
	...
	protected function render() {
		...
		if ( function_exists( 'etheme_enqueue_style' ) ) {
			etheme_enqueue_style( 'etheme-price-table', true );
		}
...
//						$this->add_inline_editing_attributes( 'original-price' );
