...
class Product_Menu_Layout extends \Elementor\Widget_Base {
	...
	public function get_title() {
		return __( 'Product Menu Layout', 'xstore-core' );
	}
	...
	protected function _register_controls() {
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__('Custom Content', 'xstore-core'),
		...
		$this->add_control(
			'custom_content_tab',
			[
				'label' => __( 'Custom Item', 'xstore-core' ),
		...
		if ( $settings['type'] == 'products' ) {
			...
			if ( $settings['custom_content_tab'] ) { ?>
				...
				<?php foreach ( $settings['custom_content_tab'] as $item ) {
					$local_options = array();
					$local_options['classes'] = array('product');
					$local_options['classes'][] = 'product-view-menu';
					$local_options['classes'][] = etheme_get_product_class( $settings['columns'] );
