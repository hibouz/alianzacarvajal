...
//					'large'                         => esc_html__('Large', 'xstore-core'),
		...
		$this->start_controls_section(
			...
			[
				'label' => __( 'Hover Effects Settings', 'xstore-core' ),
				'tab' 	=> \Elementor\Controls_Manager::TAB_CONTENT,
			]
		);
...
//		);
		...
		$this->start_controls_section(
			'section_style',
			[
				'label' => __( 'Item Style', 'xstore-core' ),
		...
		$this->add_responsive_control(
			...
			[
				...
				'size_units' => [ 'px', '%' ],
				'selectors' => [
					'{{WRAPPER}} img + .categories-mask, {{WRAPPER}} .category-bg + .categories-mask' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_responsive_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} img + .categories-mask, {{WRAPPER}} .category-bg + .categories-mask' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'selectors' => [
					'{{WRAPPER}} img + .categories-mask, {{WRAPPER}} .category-bg + .categories-mask' => 'left: {{SIZE}}{{UNIT}}; right: {{SIZE}}{{UNIT}};',
				],
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} img + .categories-mask, {{WRAPPER}} .category-bg + .categories-mask'
			]
		);
		...
		$this->add_group_control(
			...
			[
				...
				'types' => [ 'classic', 'gradient' ],
				'selector' => '{{WRAPPER}} img + .categories-mask:hover, {{WRAPPER}} .category-bg + .categories-mask:hover'
			]
		);
