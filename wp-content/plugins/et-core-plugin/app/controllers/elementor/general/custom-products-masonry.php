...
class Custom_Products_Masonry extends \Elementor\Widget_Base {
	...
	public function get_keywords() {
		return [ 'custom', 'masonry', 'isotope', 'products', 'categories', 'layout' ];
	}
...
//				'title_field' => '{{{ product }}}',
		...
		$this->start_controls_section(
			'style_section',
			[
				'label' => esc_html__( 'General Styles', 'xstore-core' ),
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Content Styles', 'xstore-core' ),
				'tab' =>  \Elementor\Controls_Manager::TAB_STYLE,
			]
		);
		...
		$this->add_control(
			...
			[
				'label'		 =>	esc_html__( 'Elements Spacing', 'xstore-core' ),
				'type' 		 => \Elementor\Controls_Manager::SLIDER,
				'size_units' => [ 'px' ],
				'range' => [
					'px' 		=> [
		...
		$this->start_controls_section(
			'name_style_section',
			[
				'label' => esc_html__( 'Name Styles', 'xstore-core' ),
				'tab' =>  \Elementor\Controls_Manager::TAB_STYLE,
				'conditions' 	=> [
					'terms' 	=> [
						[
		...
		$this->start_controls_section(
			'price_style_section',
			[
				'label' => esc_html__( 'Price Styles', 'xstore-core' ),
				'tab' =>  \Elementor\Controls_Manager::TAB_STYLE,
				'conditions' 	=> [
					'terms' 	=> [
						[
		...
		$this->start_controls_section(
			...
			[
				'label' => esc_html__( 'Add To Cart Styles', 'xstore-core' ),
				'tab' =>  \Elementor\Controls_Manager::TAB_STYLE,
				'conditions' 	=> [
					'terms' 	=> [
						[
	...
	protected function render() {
		...
		$title_limit = $settings['name_limit']['size'];
		
		if ( function_exists('etheme_enqueue_style')) {
			etheme_enqueue_style( 'etheme-custom-masonry', true );
		}
        ...
        if ( \Elementor\Plugin::$instance->editor->is_edit_mode() ? true : false )
