...
add_filter('et/customizer/add/fields/product_gallery', function ( $fields ) use($separators,$strings,$choices,$box_models){
	...
	$args = array(
		...
		'go_to_section_product_sale_label'	=>	 array(
			...
			'section'     => 'product_gallery',
			'default'     => '<span class="et_edit" data-parent="product_sale_label" data-section="product_sale_label_content_separator" style="padding: 5px 7px; border-radius: 2px; background: #222; color: #fff; ">' . esc_html__( 'Sale label', 'xstore-core' ) . '</span>',
			'priority'	  => 6,
		),
		...
		'go_to_section_woocommerce_product_images'	=>	 array(
			...
			'section'     => 'product_gallery',
			'default'     => '<span class="et_edit" data-parent="woocommerce_product_images" data-section="woocommerce_single_image_width" style="padding: 5px 7px; border-radius: 2px; background: #222; color: #fff; ">' . esc_html__( 'Image sizes', 'xstore-core' ) . '</span>',
			'priority'	  => 7,
		),
		...
		'go_to_section_variations-gallery'	=>	 array(
			...
			'section'     => 'product_gallery',
			'default'     => '<span class="et_edit" data-parent="variations-gallery" data-section="enable_variation_gallery" style="padding: 5px 7px; border-radius: 2px; background: #222; color: #fff; ">' . esc_html__( 'Variations gallery', 'xstore-core' ) . '</span>',
			'priority'	  => 8,
		),
