<?php 
	...
	add_filter('et/customizer/add/fields/main_menu', function ( $fields ) use($separators,$strings,$choices,$menu_settings,$post_types){
		$args = array();
		...
		$args = array(
			...
			'go_to_section_secondary_menu_1'	=>	 array(
				...
				'section'     => 'main_menu',
				'default'     => '<span class="et_edit" data-parent="menu_dropdown" data-section="menu_dropdown_style_separator" style="padding: 5px 7px; border-radius: 2px; background: #222; color: #fff; ">' . esc_html__( 'Dropdown settings', 'xstore-core' ) . '</span>',
				'priority'    => 27,
			),
