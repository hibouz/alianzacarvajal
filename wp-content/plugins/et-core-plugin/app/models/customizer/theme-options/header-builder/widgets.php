...
add_filter('et/customizer/add/fields/header_widgets', function ( $fields ) use($sep_style,$post_types){
	$args = array();
	...
	$args = array(
		...
		'go_to_section_panel-widgets1'	=>	 array(
			...
			'section'     => 'header_widgets',
			'priority'    => 3,
			'default'     => '<span class="et_edit" data-parent="panel-widgets" data-section="sidebar-widgets-prefooter" style="padding: 5px 7px; border-radius: 2px; background: #222; color: #fff; ">' . esc_html__( 'Widget areas', 'xstore-core' ) . '</span>',
		),
