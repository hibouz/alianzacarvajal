...
add_filter('et/customizer/add/fields/search', function ( $fields ) use($separators,$strings,$choices,$sep_style,$sidebars_with_inherit,$post_types,$box_models){
	$args = array();
	// Array of fields
	$args = array(
		...
		'search_categories_et-desktop'	=> array (
			...
			'priority'    => 10,
			'multiple'    => 6,
			'choices'     => $post_types['product_categories'],
			'active_callback' => array(
				array(
					'setting'  => 'search_type_et-desktop',
					'operator' => '==',
		...
		'search_input_box_model_et-mobile'	=> array(
			...
			'output'	  => array(
				...
				array(
					'choice' => 'border-right-width',
					'context'	=> array('editor', 'front'),
					'element' => '.mobile-header-wrapper .et_b_header-search.et_element-top-level select, .mobile-header-wrapper .et_b_header-search.et_element-top-level .fancy-select .fancy-placeholder-text',
					'property' => 'border-right-width'
				),
			),
			'transport' => 'postMessage',
		...
		'search_content_box_model_et-desktop'	=> array(
			...
			'output'	=> array(
				...
				array(
					'choice' => 'padding-top',
					'context'	=> array('editor', 'front'),
					'element' => '.et-content-dropdown .ajax-results-title:first-child',
					'property' => 'margin-top',
					'value_pattern' => '-$'
				),
				array(
					'choice' => 'padding-bottom',
					'context'	=> array('editor', 'front'),
					'element' => '.et-content-dropdown .ajax-results-more:last-child',
