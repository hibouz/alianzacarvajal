...
<div class="et_customizer-builder et_customizer-builder-header hidden">
	...
	<div class="et_device et_desktop-mod">
		...
		$blocks = ( $ajax ) ? json_decode($ajax['connect_block_package'], true) : get_theme_mod( 'connect_block_package', $connect_block_package );
		if ( $blocks && $blocks != '[]' && count( $blocks ) ) {
		...
		<div class="et_header-part et_header-top" data-name="Top Header" data-section="header_top_elements">
			<?php
			$data      = ( $ajax ) ? json_decode($ajax['header_top_elements'], true) : json_decode( get_theme_mod( 'header_top_elements', '' ), true );
			$cols_html = '';
		...
		<div class="et_header-part et_header-main" data-name="Main Header" data-section="header_main_elements">
			<?php
			$data      = ( $ajax ) ? json_decode($ajax['header_main_elements'], true) : json_decode( get_theme_mod( 'header_main_elements', '' ), true );
			$cols_html = '';
		...
		<div class="et_header-part et_header-bottom" data-name="Bottom Header" data-section="header_bottom_elements">
			<?php
			$data      = ( $ajax ) ? json_decode($ajax['header_bottom_elements'], true) : json_decode( get_theme_mod( 'header_bottom_elements', '' ), true );
			$cols_html = '';
	...
	<div class="et_device et_mobile-mod hidden">
		...
		$blocks   = ( $ajax ) ? json_decode($ajax['connect_block_mobile_package'], true) : get_theme_mod( 'connect_block_mobile_package' );
		...
		<div class="et_header-part et_header-top" data-name="Top Header" data-section="header_mobile_top_elements">
			<?php
			$data      = ( $ajax ) ? json_decode( $ajax['header_mobile_top_elements'], true ) : json_decode( get_theme_mod( 'header_mobile_top_elements', '' ), true );
			$cols_html = '';
		...
		<div class="et_header-part et_header-main" data-name="Main Header" data-section="header_mobile_main_elements">
			<?php
			$data      = ( $ajax ) ? json_decode( $ajax['header_mobile_main_elements'], true ) : json_decode( get_theme_mod( 'header_mobile_main_elements', '' ), true );
			$cols_html = '';
		...
		<div class="et_header-part et_header-bottom" data-name="Bottom Header" data-section="header_mobile_bottom_elements">
			<?php
			$data      = ( $ajax ) ? json_decode( $ajax['header_mobile_bottom_elements'], true ) : json_decode( get_theme_mod( 'header_mobile_bottom_elements', '' ), true );
			$cols_html = '';
