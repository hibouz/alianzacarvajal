...
$columns = ( $ajax ) ? json_decode($ajax['product_single_elements'], true) : json_decode( get_theme_mod( 'product_single_elements', $product_single_elements ), true );
...
$blocks = ( $ajax ) ? json_decode($ajax['connect_block_product_single_package'], true) : get_theme_mod( 'connect_block_product_single_package' );
...
<div class="et_customizer-builder et_customizer-builder-single_product hidden" data-option="product_single_elements">
