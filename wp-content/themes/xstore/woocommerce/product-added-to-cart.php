            ...
            <td class="product-details col-md-9">
                <div class="cart-item-details align-start">
			        ...
			        echo apply_filters( 'woocommerce_cart_item_remove_link', sprintf(
				        '<a href="%s" class="remove remove_from_cart_button text-underline block" aria-label="%s" data-product_id="%s" data-cart_item_key="%s" data-product_sku="%s">%s</a>',
